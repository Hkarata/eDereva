...
namespace eDereva.Api.Endpoints.Roles
{
    public class GetRoleIdsEndpoint(IRoleRepository roleRepository) : EndpointWithoutRequest<List<Guid>>
    {
        public override void Configure()
        {
            ...
            Description(options =>
            {
                options.WithTags("Role")
                    ...
                    .WithDescription("This endpoint retrieves a list of all role IDs in the system. Returns a list of unique identifiers (GUIDs) for all available roles.");
            });
        }
        ...
        public override async Task HandleAsync(CancellationToken ct)
        {
            ...
            await SendOkAsync(roleIds, cancellation: ct);
            return;
        }
    }
}
