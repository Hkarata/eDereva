    ...
    public override void Configure()
    {
        ...
        Description(options =>
        {
            options.WithTags("Role")
                ...
                .WithDescription(
                    "This endpoint allows the creation of a new role with associated permissions. The request should include role details such as name, description, and any permissions to be assigned to the role.");
        });
    }
