        ...
        public override void Configure()
        {
            ...
            Description(options =>
            {
                options.WithTags("Role")
                    ...
                    .WithDescription("This endpoint updates an existing role with the provided details. The role ID must be specified in the route, and the updated role details should be provided in the request body.");
            });
        }
