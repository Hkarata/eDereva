...
public interface ISessionRepository
{
    ...
    Task<PaginatedResult<SessionDto>> GetByVenueIdAsync(Guid venueId, PaginationParams paginationParams, CancellationToken cancellationToken = default);
    ...
    Task<PaginatedResult<SessionDto>> GetSessionsByDateRangeAsync(DateTime startDate, DateTime endDate, PaginationParams paginationParams,CancellationToken cancellationToken = default);
