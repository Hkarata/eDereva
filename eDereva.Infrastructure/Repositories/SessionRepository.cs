    ...
    : ISessionRepository
{
        ...
        CancellationToken cancellationToken = default)
    {
        logger.LogInformation(
            "Fetching sessions for Venue ID: {VenueId} with pagination: Page {PageNumber}, Size {PageSize}",
    ...
    {
        logger.LogInformation(
            "Fetching sessions for Contingency ID: {ContingencyId} with pagination: Page {PageNumber}, Size {PageSize}",
        ...
        logger.LogInformation("Fetched {TotalCount} sessions for Contingency ID: {ContingencyId}.", totalCount,
            contingencyId);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        logger.LogInformation("Fetched {SessionCount} sessions between {StartDate} and {EndDate}.", sessions.Count,
            startDate, endDate);
    ...
    public async Task<bool> SoftDeleteAsync(Guid id, CancellationToken cancellationToken = default)
    {
        ...
        var session = await context.Sessions.FindAsync([id, cancellationToken], cancellationToken);
        if (session == null)
        {
    ...
    public async Task<bool> CheckSessionsByVenueAndDate(Guid pairVenueId, DateTime pairDate,
