...
namespace eDereva.Infrastructure.Migrations
{
    ...
    [Migration("20250108131848_UserLicenseUpdateMigration")]
    partial class UserLicenseUpdateMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eDereva.Core.Entities.SectionTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("eDereva.Core.Entities.Test", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("eDereva.Core.Entities.TestSection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("eDereva.Core.Entities.Question", b =>
                {
                    b.HasOne("eDereva.Core.Entities.SectionTemplate", "SectionTemplate")
                        .WithMany("Questions")
                        .HasForeignKey("SectionTemplateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("eDereva.Core.Entities.TestSection", null)
                        .WithMany("Questions")
            ...
            modelBuilder.Entity("eDereva.Core.Entities.TestSection", b =>
                {
                    ...
                    b.HasOne("eDereva.Core.Entities.Test", "Test")
