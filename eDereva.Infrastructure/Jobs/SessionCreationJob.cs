...
namespace eDereva.Infrastructure.Jobs
{
    ...
    ) : ISessionCreationJob
    {
        ...
        private Task<(Guid VenueId, DateTime Date, List<Session> sessionList)> ProcessVenueDatePairAsync((Guid VenueId, DateTime Date) pair)
        {
        ...
        IEnumerable<(TimeOnly StartTime, TimeOnly EndTime)> GenerateSessionSlots()
        {
